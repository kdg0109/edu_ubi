...
public class FactorialTest
{
    ...
    public void testGetZeroCount() throws UbiveloxException
    {
        ...
        // assertEquals(4, Factorial.getZeroCount(20, 18));
        ...
        // assertEquals(8, Factorial.getZeroCount(20, 12));
