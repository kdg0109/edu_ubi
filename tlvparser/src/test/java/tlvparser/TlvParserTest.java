...
public class TlvParserTest
{
    ...
    public void testException() throws UbiveloxException, GaiaException
    {
        ...
        parseException("", "005500", "Tag is not correct");
        parseException("", "004400", "Tag is not correct");
        parseException("", "003300", "Tag is not correct");
        parseException("", "002200", "Tag is not correct");
        parseException("", "001100", "Tag is not correct");
        parseException("", "000000", "Tag is not correct");
        parseException("", "00EF", "Tag is not correct");
        parseException("", "00DF", "Tag is not correct");
        parseException("", "00CF", "Tag is not correct");
        parseException("", "00BF", "Tag is not correct");
        parseException("", "00AF", "Tag is not correct");
        parseException("", "0080", "Tag is not correct");
        parseException("", "0005", "Tag is not correct");
        parseException("", "0004", "Tag is not correct");
        parseException("", "0003", "Tag is not correct");
        parseException("", "0002", "Tag is not correct");
        parseException("", "0001", "Tag is not correct");
        parseException("", "00", "Tag is not correct");
